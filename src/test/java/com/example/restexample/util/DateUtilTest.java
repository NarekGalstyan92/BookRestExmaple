...
class DateUtilTest {
    ...
    void textToDateNull() throws ParseException {
        String dateTxt = null;
//        assertThrows(NullPointerException.class, () -> {dateUtil.textToDate(dateTxt);});
        assertNull(dateUtil.textToDate(dateTxt));

    }
    @Test
    void textToDateParseException(){
        String dateTxt = "02.02.2022";
        assertThrows(ParseException.class, () -> {dateUtil.textToDate(dateTxt);});
    ...
    void dateToText() throws ParseException {
        Date parseDate = sdf.parse("03-03-2022");
